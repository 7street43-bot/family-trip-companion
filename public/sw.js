...
const CORE_PATHS = new Set([
  '/', '/index.html', '/runtime-config.js', '/update-manager.js', '/update-manager.css', '/app.css', '/itinerary-v2.css', '/itinerary-v2-core.mjs', '/itinerary-candidates-core.mjs', '/itinerary-v2.mjs', '/itinerary-origin.css', '/itinerary-origin.mjs', '/journal.css', '/journal-media.css', '/journal-nav.css', '/journal-stable.css', '/db.js', '/cloud-sync.js', '/journal-shell.mjs', '/journal-browser.mjs', '/journal-ui.mjs', '/journal-nav-bridge.mjs', '/journal-media-ui.mjs', '/journal-media-preview-demo.mjs', '/journal-stable-layout.mjs',
