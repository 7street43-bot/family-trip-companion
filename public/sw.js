const CACHE = 'twin-trip-v4.5.0-phase1.6-j1g.1';
const CORE_PATHS = new Set([
  '/', '/index.html', '/app.css', '/journal.css', '/journal-media.css', '/db.js', '/cloud-sync.js', '/journal-browser.mjs', '/journal-ui.mjs', '/journal-media-ui.mjs',
